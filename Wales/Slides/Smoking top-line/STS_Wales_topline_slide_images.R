...
setwd("C:/Toolkit merge files/R Script/Slides/Wales/Top line")
getwd()
...
df6_long %>% ggplot(aes(Year, estimate, group = intervals)) + 
  geom_line(aes(color = intervals), size = 1.3) +
  scale_colour_manual(name = "", breaks = c("Prev","LCI","UCI"), values = top_colours) +
  ylab("Percent") + ylim(0, 15) +
  theme_clean(base_size = 18) + theme(legend.position = "none")

ggsave("stopped_wal.png")
...
df6_long %>% ggplot(aes(Year, estimate, group = intervals)) + 
  geom_line(aes(color = intervals), size = 1.3) +
  scale_colour_manual(name = "", breaks = c("Prev","LCI","UCI"), values = top_colours) +
  ylab("Percent") + ylim(0,90) +
  theme_clean(base_size = 18) + theme(legend.position = "none")

ggsave("triedstop1824_wal.png")
...
ggsave("successstop1824_wal.png")
...
df6_long %>% ggplot(aes(Year, estimate, group = intervals)) + 
  geom_line(aes(color = intervals), size = 1.3) +
  scale_colour_manual(name = "", breaks = c("Prev","LCI","UCI"), values = top_colours) +
  ylab("Percent") + ylim(0, 70) +
  theme_clean(base_size = 18) + theme(legend.position = "none")

ggsave("uptake1824_wal.png")
